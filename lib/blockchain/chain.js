...
Chain.prototype.getTarget = async function getTarget(time, prev) {
  ...
  if (this.network.type === 'testnet') {
    ...
    if (height < 26754) {
      ...
      return 0x1e0ffff0;
    } else if (height >= 1080000 && height < 1080010) { // Force difficulty for 10 blocks - Lyra2REv3 hardfork
      return 0x1b0ffff0;
    } else if (height >= 1500000 && height < 1500010) { // Force difficulty for 10 blocks - Verthash hardfork
      return 0x1c07fff8;
    }
  }
